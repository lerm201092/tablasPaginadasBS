...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"<span class='glyphicon glyphicon-chevron-right'></span>",sPrevious:"<span class='glyphicon glyphicon-chevron-left'></span>"},sEmptyTable:"No data available in table",sInfo:"Registro _START_ al _END_ ( _TOTAL_ Registros)",sInfoEmpty:"Registro 0 de 0 de 0 Registros",
sInfoFiltered:"(Filtrados de _MAX_  Registros)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Listar _MENU_ Registros",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:g.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
